...
<Meta title="1. Fundamentals of Programming/1.2 Data Types & Operations/1.2.4 Booleans/1.2.4.1 Introduction" />

# 1.2.4.1 Booleans - Introduction
...
The **Logic** section is the also found in the green **Data** section of the Pybricks Code Editor, its the secon subsection called **Logic**:
...
In the green **Data** section, you'll find the comparison block. This block lets you ask questions like "Is 5 greater than 3?" or "Is 10 equal to 10?"
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-1.1.png"
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-2.1.png"
  alt="Using variables in comparisons"
  style={{ width: "50%" }}
/>
...
Booleans aren't just for numbers - they work amazingly well with text (strings) too! Your robot can ask questions about text just like it asks questions about numbers.

### String Comparisons

You can compare strings using the same operators you use with numbers. This is incredibly useful for robot commands, status messages, and decision-making:

<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-STR-1.png"
  alt="String comparison operations"
  style={{ width: "50%" }}
/>
...
print(robot_status == "ready")    # Is the robot ready?
print(command == "stop")          # Is the command to stop?
print(robot_status != "error")    # Is the robot NOT in error state?
```
...
### The 'in' Operator - Text Detective Work

Here's one of the most powerful tools for working with strings: the `in` operator. It checks if one piece of text exists inside another piece of text. Think of it like a detective looking for clues!

<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-STR-2.png"
  alt="String 'in' operator"
  style={{ width: "50%" }}
/>

```python
# The main program starts here.
print('a' in 'abc')           # Is 'a' found in 'abc'?
print('robot' in 'My robot is awesome')  # Is 'robot' in the sentence?
print('xyz' in 'abc')         # Is 'xyz' found in 'abc'?
```
...
This is incredibly useful for robotics! Imagine your robot receiving commands or status messages:

<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-STR-3.png"
  alt="Practical string operations for robotics"
  style={{ width: "75%" }}
/>

```python
# The main program starts here.
sensor_data = "temperature: 25C, battery: 85%"
error_message = "sensor error detected"

print("battery" in sensor_data)    # Check if battery info is present
print("error" in error_message)    # Check if there's an error
print("25" in sensor_data)         # Check for specific temperature
```
...
Your robot can now understand and react to text-based information! This opens up amazing possibilities for communication and decision-making.
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-1.4.png"
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-2.2.png"
  alt="Logical OR operation"
  style={{ width: "50%" }}
/>
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-2.3.png"
  alt="Combining comparisons with logical operations"
  style={{ width: "75%" }}
/>
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-1.5.png"
  alt="NOT operation"
  style={{ width: "50%" }}
/>
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-1.3.png"
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-1.2.png"
...
<img
  src="/1-fundamentals-of-programming/1.2-data-types-operations/1.2.4-booleans/res/BOO-2.4.png"
  alt="Working with None values"
  style={{ width: "50%" }}
/>
